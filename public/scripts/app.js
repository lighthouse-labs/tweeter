...
$( document ).ready(function() {
  ...
  function createTweetElement(tweet) {
    ...
    let $tweet = $('<div id="tweet-container"><div class="header"><header><img alt="vanil12" src="' + avatarUrl + '"><span class="full-name"> ' + fullName + ' </span><span class="at-name"> ' + atName + ' </span></header></div><article><p> ' + tweetContent + ' </p></article><footer><span> ' + timeStamp + ' </span><div class="icons"><i class="fa fa-flag mini-icons" aria-hidden="true"></i><i class="fa fa-retweet mini-icons" aria-hidden="true"></i><i class="fa fa-heart mini-icons" aria-hidden="true"></i></div></footer></div>');
...
// preppend()
  ...
  function renderTweets(tweets) {
    ...
    for(tweet in tweets){
      ...
      $('#display-tweets').append(fullTweet);
    }
  }
